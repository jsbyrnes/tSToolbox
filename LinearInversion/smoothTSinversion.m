...
fnames = dir('../../TDcode2D/Rio_nofilt/*Measurement.mat');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
buffr=1; %buffer size on all sides, on km. (edges will be at edge of footprint+buffer)
...
figure(1); contourf(xMat,yMat,MImodel, v); h = colorbar; %caxis([0 2])
...
scatter(dataX,dataY,10, MIsta,'filled', 'MarkerEdgeColor', 'k')
set(gca,'YDir','normal')
daspect([1 1 1])
