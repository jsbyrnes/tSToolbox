function [ outTr, d ] = wfEllipFilter_HighPass( inTr, freqs, phase, d)
...
if nargin ~= 4
    ...
    d = designfilt('highpassiir', 'StopbandFrequency', freqs-0.05, 'PassbandFrequency', ...
        freqs+0.05, 'StopbandAttenuation', 60, 'PassbandRipple', 1, 'SampleRate', inTr(1).sampleRate, ...
        'DesignMethod', 'ellip');
